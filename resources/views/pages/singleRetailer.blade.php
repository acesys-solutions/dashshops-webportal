                            ...
                            <div class="col-md-8 col-sm-12 mt-4" style="margin-bottom: 15%">
                                ...
                                <div style="margin-top: 10%">
                                    ...
                                    <h5 class="text-black-50">
                                        <a href="{{$retailer->web_url}}" target="_blank">{{$retailer->web_url}}</a>
                                    </h5>
                                </div>
                                <div style="margin-top: 10%">
                                    <h3 class="font-weight-bold">Created By:</h3>
                                    <h5 class="text-black-50">@if($retailer->user){{$retailer->user->lastname}} {{ $retailer->user->firstname }}@else {{$retailer->lastname}} {{ $retailer->firstname }} @endif</h5>
                                </div>
                            </div>
                            <div class="col-md-4 col-sm-12 justify-content-center mt-5">
                                <img src="{{asset('images/retailers/'.$retailer->banner_image)}}" alt="logo" style="width: 300px; height: 300px; object-fit:cover" />
                                                ...
                                                <form method="POST" enctype="multipart/form-data" id="upload-image" action="{{ route('update-logo', $retailer->id) }}">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 mb-2">
                                                            <img id="preview-image-before-upload" src="https://www.riobeauty.co.uk/images/product_image_not_found.gif" alt="preview image" style="max-height: 250px; width: 100%; object-fit:contain">
                                                        </div>
